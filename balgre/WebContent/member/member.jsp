	...
	<form name="regFrm" method="post" action="memberProc.jsp">
		<ul class="member">
			<li>
				...
				<button  onClick="idCheck(this.form.id.value)" class="btn btn-success check-btn">ID 중복확인</button>
				<div class="clear"></div>
			</li>
			<li><input type="password" name="pass" placeholder="비밀번호" class="form-control"></li>
			<li><input type="password" name="repass" placeholder="비밀번호 확인" class="form-control"></li>
			<li><input type="text" name="name" placeholder="이름" class="form-control"></li>
			<li>
				성별 : 남 <input type="radio" name="sex" value="1" checked="checked">&nbsp;
				여 <input type="radio" name="sex" value="2">
			</li>
			<li><div class="text-birth">생일 : </div> <input type="date" name="birthday" class="form-control input-birth" ></li>			
			<div class="clear"></div>
			<li><input type="email" name="email" placeholder="이메일" class="form-control"></li>
			<li>
